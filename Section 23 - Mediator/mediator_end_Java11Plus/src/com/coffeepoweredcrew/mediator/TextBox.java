...
public class TextBox extends TextField implements UIControl{
	//When TextBox changes, Slider and Label update
	//When Slider changes, TextBox and Label update
	...
	public void controlChanged(UIControl control) {
		...
		this.setText(control.getControlValue()); //When we set this listener is called
